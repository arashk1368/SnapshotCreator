...
public class App {
    ...
    private final static String TRAIN_FOLDER_PREFIX = "WithContext/RESTS/";
    private final static String TEST_FOLDER_PREFIX = "WithoutContext/RESTS/";
...
//        removeNoise();
    ...
    private static void createXML() {
        ...
        try {
//            xmlCreator.generate(STARTING_SNAPSHOT_ID_XML, ENDING_SNAPSHOT_ID_XML, DESCRIPTION_TYPE_XML, XML_ADDRESS, XML_STRATEGY, CTX_REPOS_ADDRESS, PLAIN_REPOS_ADDRESS,TRAIN_FOLDER_PREFIX,TEST_FOLDER_PREFIX,COPY, TEMP_ADDRESS, CREATE_SEPARATE);
//            xmlCreator.generate(DESCRIPTION_TYPE_XML, XML_STRATEGY, TESTING_PERCENTAGE, CTX_REPOS_ADDRESS, PLAIN_REPOS_ADDRESS,TRAIN_FOLDER_PREFIX,TEST_FOLDER_PREFIX,COPY, TEMP_ADDRESS, CREATE_SEPARATE);
            xmlCreator.generate10Fold(DESCRIPTION_TYPE_XML, XML_STRATEGY, CTX_REPOS_ADDRESS, PLAIN_REPOS_ADDRESS, TRAIN_FOLDER_PREFIX, TEST_FOLDER_PREFIX, COPY, TEMP_ADDRESS, CREATE_SEPARATE);
